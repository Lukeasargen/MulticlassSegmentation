...
from util import time_to_string, pil_loader, prepare_image, get_data
...
if __name__ == "__main__":
    ...
    # Dataset parameters
    data_root = "data"
    validation_split = 0.05  # percent used for validation as a decimal, only if the data root has no val folder
    ...
    train_transforms = T.Compose([
        ...
        T.RandomResizedCrop(input_size, scale=(0.08, 1.0), ratio=(3./4., 4./3.)),
        T.RandomChoice([
